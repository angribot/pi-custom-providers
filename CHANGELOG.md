...
- Moved tests out of the published source tree and migrated them from JavaScript to TypeScript.
...
[Unreleased]: https://github.com/angribot/pi-custom-providers/compare/v0.3.2...HEAD
